...
public class Main {
	...
	public static void main(String[] args) {
		...
		tests[0] = new Test(3,"test1","toto je prvy test"); 		
			...
			//otazka 2
			tests[0].questions[1] = new Question(4, "otazka1:", "text otazky1");
				//moznosti
			...
			//otazka 3
			tests[0].questions[2] = new Question(4, "otazka1:", "text otazky1");
				//moznosti
		...
		tests[1] = new Test(3,"test2","toto je druhy test"); 		
			...
			//otazka 2
			tests[1].questions[1] = new Question(4, "otazka1:", "text otazky1");
				//moznosti
			...
			//otazka 3
			tests[1].questions[2] = new Question(4, "otazka1:", "text otazky1");
				//moznosti
		...
		//testy
		for(int a = 0; a<2; a++) {
			System.out.println("nazov testu: " + tests[1].name);
			System.out.println("text testu: " + tests[1].text);
			//otazky
			for(int b = 0; b<3; b++) {				
